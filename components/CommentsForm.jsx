    ...
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4 ">
        <div>
          ...
          <label className='text-gray-500 cursor-pointer text-sm ml-2' htmlFor='storeData'> Save my email and name for the next time I comment.</label>
        </div>
      </div>
      
      {error  && <p className='text-xs text-red-700'>All fields are required!!</p>}
      <div className="mt-8">
        <button 
          type='button'
        ...
        {showSuccessMessage && 
        <span className='text-lg float-right font-semibold mt-3 text-green-700'> 
